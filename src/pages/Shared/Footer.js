...
<footer className="bg-white dark:bg-gray-900">
    <hr className='text-primary h-[5px]' />
    ...
    <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <Link href="https://flowbite.com/">Flowbite™</Link>. All Rights Reserved.
        </span>
